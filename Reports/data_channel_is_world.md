...
The data channel we will be analyzing is the world channel.
...
``` r
data0<-subset(data0, data_channel_is_world == 1)
head(data)
```
...
![](data_channel_is_world_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
