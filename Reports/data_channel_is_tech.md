...
The data channel we will be analyzing is the technology channel.
...
``` r
data0<-subset(data0, data_channel_is_tech == 1)
head(data)
```
...
![](data_channel_is_tech_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
